# CSI 6900 — Mask-Conditioned Goal-Conditioned RL for Robotic Placement

Extending mask-based goal conditioning to multi-step pick-and-place using MuJoCo Playground and JAX.

Supervisor: Prof. Colin Bellinger, University of Ottawa
...
![Learning Curve](phase1/learning_curve.png)
